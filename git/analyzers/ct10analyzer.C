...
void process(int num){
	...
	stream<<"/uscms_data/d3/hn99/ct10/ggo_ct10"<<num<<".root";
	str = stream.str();
	...
	stream2.str(""); stream2.clear(); stream2<<"Same Endcap Invariant Mass for n="<<num; str2 = stream2.str();
	...
	stream.str("");
	stream.clear();
	stream<<"/uscms_data/d3/hn99/ct10/ggt_ct10"<<num<<".root";
	str = stream.str();
	std::cout<<"Reading from "<<str.Data()<<std::endl;
	h = new TFile(str.Data());
	if (num!=126){
